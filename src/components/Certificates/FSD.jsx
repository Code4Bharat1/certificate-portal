...
export default function FsdPage() {
  ...
  const themeGradient = 'from-amber-500 via-yellow-600 to-orange-500';
  const themeColor = 'amber';
  const themeTextColor = 'text-amber-600';
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-3xl font-bold">FSD</h1>
                  <p className="text-amber-100">
                    Manage all FSD certificates
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-2 md:gap-3">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2 flex items-center gap-2">
                ...
                <div>
                  ...
                  <span className="text-xs text-amber-100 block">Certificates</span>
                </div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2 flex items-center gap-2">
                ...
                <div>
                  ...
                  <span className="text-xs text-amber-100 block">Downloaded</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-3 mb-6">
          ...
          <div className="relative flex-grow">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 text-black dark:text-white border border-gray-300 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none bg-white dark:bg-gray-800 shadow-sm"
            />
            {searchTerm && (
              <button
          ...
          <motion.button
            ...
            className={`flex items-center justify-center gap-2 px-4 py-3 bg-amber-600 dark:bg-amber-700 text-white rounded-xl hover:bg-amber-700 dark:hover:bg-amber-600 transition md:w-auto`}
          >
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none w-full pl-4 pr-10 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none text-black dark:text-white"
            >
                  ...
                  <div className="flex-1 min-w-[200px]">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        { key: 'certificate', label: 'Certificates', count: stats.certificates },
                        { key: 'letter', label: 'Letters', count: stats.letters },
                      ].map((type) => (
                        <button
                          key={type.key}
                          onClick={() => {
                            // This would need additional state management to implement
              ...
              >
                ...
                <div className="flex gap-2 mt-auto">
                  <motion.button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 bg-amber-600 dark:bg-amber-700 text-white py-2.5 rounded-lg hover:bg-amber-700 dark:hover:bg-amber-600 transition text-sm font-semibold disabled:opacity-70 disabled:cursor-not-allowed"
                  >
