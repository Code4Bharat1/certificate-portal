              ...
              >
                ...
                <div className="flex gap-2 mt-auto">
                  <motion.button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 bg-sky-600 text-white py-2.5 rounded-lg hover:bg-sky-700 transition text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                  >
