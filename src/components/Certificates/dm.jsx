...
export default function DigitalMarketingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      {/* Header with Sky Blue to Cyan gradient */}
      <div className="bg-gradient-to-r from-sky-500 via-cyan-600 to-blue-600 text-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sky-100">Manage all digital marketing certificates & letters</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 md:gap-3 w-full md:w-auto">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2 flex flex-col items-center justify-center">
                <span className="text-sm text-sky-100">Certificates</span>
                <span className="text-xl font-bold">{stats.certificates}</span>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2 flex flex-col items-center justify-center">
                <span className="text-sm text-sky-100">Letters</span>
        ...
        <div className="flex flex-col md:flex-row gap-3 mb-6">
          <div className="relative flex-grow">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 text-black border border-gray-300 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none bg-white shadow-sm"
            />
          </div>
          ...
          <motion.button
            ...
            className="flex items-center justify-center gap-2 px-4 py-3 bg-sky-600 text-white rounded-xl hover:bg-sky-700 transition"
          >
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none w-full pl-4 pr-10 py-3 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-sky-500 outline-none text-black"
            >
            ...
            >
              <div className="bg-white rounded-xl shadow-md p-5 border border-gray-200">
                ...
                <div className="flex justify-end">
                  <button onClick={clearFilters} className="text-sky-600 hover:text-sky-800 text-sm font-medium">
                    Clear all filters
                  </button>
                </div>
              </div>
            ...
            {filteredCertificates.map((cert, index) => (
              ...
              >
                ...
                <div className="flex gap-2">
                  <button className="flex-1 flex items-center justify-center gap-2 bg-sky-600 text-white py-2.5 rounded-lg hover:bg-sky-700 transition text-sm font-semibold">
                    <Download className="w-4 h-4" />
                    PDF
                  </button>
                  <button className="flex-1 flex items-center justify-center gap-2 bg-cyan-600 text-white py-2.5 rounded-lg hover:bg-cyan-700 transition text-sm font-semibold">
                    <Download className="w-4 h-4" />
                    JPG
                  </button>
