...
export default function MonthlyReportPage() {
      ...
      setCertificates([
        {
          _id: '1',
          name: 'Emily Davis',
          course: 'Monthly Performance Report',
          certificateId: 'MR2024001',
        ...
        },
        {
          _id: '2',
          name: 'Robert Wilson',
          course: 'Q1 Financial Report',
          certificateId: 'MR2024002',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      {/* Header with Teal to Emerald to Green gradient */}
      <div className="bg-gradient-to-r from-teal-500 via-emerald-600 to-green-600 text-white shadow-lg">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-teal-100">Manage all monthly report certificates & letters</p>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col md:flex-row gap-3 mb-6">
          <div className="relative flex-grow">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 text-black border border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none bg-white shadow-sm"
            />
          </div>
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none w-full pl-4 pr-10 py-3 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 outline-none text-black"
            >
            ...
            >
              <div className="bg-white rounded-xl shadow-md p-5 border border-gray-200">
                ...
                <div className="flex justify-end">
                  <button onClick={clearFilters} className="text-teal-600 hover:text-teal-800 text-sm font-medium">
                    Clear all filters
                  </button>
                </div>
              </div>
            ...
            {filteredCertificates.map((cert, index) => (
              ...
              >
                ...
                <div className="flex gap-2">
                  <button className="flex-1 flex items-center justify-center gap-2 bg-teal-600 text-white py-2.5 rounded-lg hover:bg-teal-700 transition text-sm font-semibold">
                    <Download className="w-4 h-4" />
                    PDF
                  </button>
                  <button className="flex-1 flex items-center justify-center gap-2 bg-emerald-600 text-white py-2.5 rounded-lg hover:bg-emerald-700 transition text-sm font-semibold">
                    <Download className="w-4 h-4" />
                    JPG
                  </button>
