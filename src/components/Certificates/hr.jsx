...
export default function HrPage() {
  ...
  const themeGradient = 'from-rose-500 via-pink-600 to-fuchsia-600';
  const themeColor = 'rose';
  const themeTextColor = 'text-rose-600';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 to-pink-50 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 transition-colors duration-200">
            ...
            <div className="flex gap-2 md:gap-3">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2 flex items-center gap-2">
                ...
                <div>
                  ...
                  <span className="text-xs text-rose-100 block">Certificates</span>
                </div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2 flex items-center gap-2">
                <CheckCircle className="w-5 h-5" />
                <div>
                  <span className="font-semibold text-lg">{stats.downloaded}</span>
                  <span className="text-xs text-rose-100 block">Downloaded</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row gap-3 mb-6">
          ...
          <div className="relative flex-grow">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 text-black dark:text-white border border-gray-300 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-transparent outline-none bg-white dark:bg-gray-800 shadow-sm"
            />
            {searchTerm && (
              <button
          ...
          <motion.button
            ...
            className={`flex items-center justify-center gap-2 px-4 py-3 bg-rose-600 dark:bg-rose-700 text-white rounded-xl hover:bg-rose-700 dark:hover:bg-rose-600 transition md:w-auto`}
          >
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none w-full pl-4 pr-10 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-transparent outline-none text-black dark:text-white"
            >
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20">
            <Loader2 className="w-12 h-12 text-rose-600 dark:text-rose-400 animate-spin mb-4" />
              ...
              >
                ...
                <div className="flex gap-2 mt-auto">
                  <motion.button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 bg-rose-600 dark:bg-rose-700 text-white py-2.5 rounded-lg hover:bg-rose-700 dark:hover:bg-rose-600 transition text-sm font-semibold disabled:opacity-70 disabled:cursor-not-allowed"
                  >
