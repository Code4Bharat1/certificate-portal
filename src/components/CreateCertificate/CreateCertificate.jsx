...
export default function CreateCertificateProfessional() {
  ...
  // For internship: needs category + subCategory
  // For others: needs category + batch
  useEffect(() => {
  ...
  const fetchCourses = async () => {
    ...
    try {
      ...
      setCoursesList(mockCourses);
      setCreatedCertificates(['Full Stack Development']);
    } finally {
  ...
  const getBatchOptions = () => {
    if (!formData.category || formData.category === 'internship') return [];
    return categoryConfig[formData.category]?.batches || [];
  };
  ...
  // Check if names should be loaded
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div className="space-y-5">
              ...
              {formData.category === 'internship' && (
                ...
                >
                  ...
                  <select
                    ...
                    onChange={(e) => setFormData({ ...formData, subCategory: e.target.value, internId: '', name: '', course: '' })}
                    disabled={otpVerified}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all bg-white disabled:bg-gray-100"
                  >
              ...
              {/* Batch Selection - Only for non-internship categories */}
              ...
              {shouldShowNameField() && (
                ...
                >
                  <label className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                    ...
                    {formData.category === 'internship' ? 'Intern Name' : 'Student Name'}
                  </label>
                  {loadingNames ? (
